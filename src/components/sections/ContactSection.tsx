      ...
      <div className="w-full max-w-5xl">
        ...
        <div className="mb-12 md:mb-16 text-center md:text-left">
          ...
          <p className="mt-4 text-[var(--color-text-secondary)] max-w-2xl">
            Ada pertanyaan, tawaran kerja, atau sekadar ingin menyapa? Jangan ragu untuk mengirim
            pesan melalui form di bawah atau via media sosial.
          </p>
        </div>
        ...
        >
            ...
            <div className="flex flex-col gap-6 rounded-2xl border border-[var(--color-border)] bg-[var(--color-bg-surface)] p-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex flex-col">
                  ...
                  <a
                    href={`https://drive.google.com/file/d/1o2uuU3WLrY5zUTHGSBH1OVphIfyUlDoE/view?usp=drive_link`}
                    target="_blank"
                    className="text-base font-semibold text-[var(--color-text-primary)] hover:underline break-all"
                  >
                    Ringkasan Profil
                  </a>
                </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex flex-col">
                  ...
                  <a
                    ...
                    target="_blank"
                    className="text-sm font-semibold text-[var(--color-text-primary)] hover:underline break-all"
                  >
                    {OWNER_INFO.email}
                  </a>
                </div>
          ...
          <motion.div
            ...
            className="w-full lg:w-2/3 flex flex-col gap-8 rounded-2xl border border-[var(--color-border)] bg-[var(--color-bg-surface)] p-8"
          >
