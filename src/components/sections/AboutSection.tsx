    ...
    <section className="flex min-h-screen w-full items-center justify-center py-24 px-6 sm:px-10">
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <motion.div variants={leftSlideVariants} className="w-full lg:w-1/3 flex flex-col items-center lg:items-start">
          ...
          <motion.div variants={rightSlideVariants} className="w-full lg:w-2/3 flex flex-col gap-8">
            <div className="prose prose-neutral dark:prose-invert max-w-none">
              <p className="text-lg leading-relaxed text-[var(--color-text-secondary)]">
                ...
                hasrat mendalam terhadap desain antarmuka dan arsitektur sistem. 
                Fokus utama saya adalah membangun aplikasi web yang <strong>cepat, aman, 
                dan mudah diakses</strong> oleh semua orang.
              </p>
              <p className="text-lg leading-relaxed text-[var(--color-text-secondary)] mt-4">
                ...
                infrastruktur serverless (Firebase/Vercel), saya menikmati proses 
                menerjemahkan masalah bisnis yang kompleks menjadi solusi teknis yang elegan.
              </p>
              <p className="text-lg leading-relaxed text-[var(--color-text-secondary)] mt-4">
                Ketika saya tidak sedang berhadapan dengan layar editor kode, saya 
                biasanya menghabiskan waktu mempelajari teknologi baru, berkontribusi pada 
                proyek *open source*, atau sekadar meracik kopi yang sempurna.
              </p>
            </div>

            {/* Highlight Cards */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
              <motion.div variants={cardVariants} className="flex flex-col gap-2 rounded-2xl border border-[var(--color-border)] bg-[var(--color-bg-surface)] p-6 transition-colors hover:border-[var(--color-text-muted)]">
                ...
                <p className="text-sm font-medium text-[var(--color-text-secondary)]">Proyek Terselesaikan</p>
              </motion.div>
              ...
              <motion.div variants={cardVariants} className="flex flex-col gap-2 rounded-2xl border border-[var(--color-border)] bg-[var(--color-bg-surface)] p-6 transition-colors hover:border-[var(--color-text-muted)]">
                ...
                <p className="text-sm font-medium text-[var(--color-text-secondary)]">Tahun Pengalaman</p>
              </motion.div>
            </div>
          </motion.div>
