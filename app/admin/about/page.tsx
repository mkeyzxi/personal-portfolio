...
export default function AdminAboutDashboard() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto min-h-screen bg-[var(--color-bg-main)]">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold text-[var(--color-text-primary)]">About CMS</h1>
        <button 
          onClick={handleSave} 
          disabled={isSaving}
          className="flex items-center gap-2 bg-[var(--color-interactive)] text-[var(--color-interactive-text)] px-4 py-2 rounded-md hover:bg-[var(--color-interactive-hover)] transition-colors disabled:opacity-50"
        >
