  ...
  return (
    <div className="p-6 md:p-8 max-w-6xl mx-auto min-h-screen bg-[var(--color-bg-main)]">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-[var(--color-text-primary)]">Jejak Langkah (Journey)</h1>
          <p className="text-sm text-[var(--color-text-secondary)] mt-1">Kelola riwayat peristiwa atau pencapaian penting dari waktu ke waktu.</p>
        </div>
        <button 
