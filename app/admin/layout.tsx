        ...
        <aside className="w-64 bg-[var(--color-bg-surface)] border-r border-[var(--color-border)] flex flex-col hidden md:flex shrink-0">
          ...
          <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
            ...
            <Link 
              href="/admin/about"
              className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-colors ${
                pathname.includes('/admin/about') ? 'bg-[var(--color-interactive)] text-[var(--color-interactive-text)]' : 'hover:bg-[var(--color-bg-elevated)] text-[var(--color-text-secondary)]'
              }`}
            >
            ...
            <Link 
              ...
              className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-colors ${
                pathname.includes('/admin/experiences') ? 'bg-[var(--color-interactive)] text-[var(--color-interactive-text)]' : 'hover:bg-[var(--color-bg-elevated)] text-[var(--color-text-secondary)]'
              }`}
            >
